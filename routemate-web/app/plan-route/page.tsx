    ...
    <DashboardLayout>
      ...
      <div className="mb-6">
        ...
        <div className="mt-4 grid grid-cols-12 gap-6">
          <div className="col-span-3 flex items-start gap-3 p-3 bg-blue-50 rounded-xl border border-blue-100 shadow-sm">
          ...
          <div className="col-span-4 flex items-start gap-3 p-3 bg-amber-50 rounded-xl border border-amber-100 shadow-sm">
          ...
          <div className="col-span-5 flex items-start gap-3 p-3 bg-green-50 rounded-xl border border-green-100 shadow-sm">
