  ...
  return (
    <DashboardLayout>
      ...
      <div className="grid grid-cols-12 gap-4 h-full min-h-0">
        ...
        <div className="col-span-5 rounded-xl flex flex-col gap-4 overflow-hidden min-h-0">
        ...
        <div className="col-span-7 flex flex-col gap-4 overflow-hidden">
          <div className="shrink-0 max-h-[370px]">
            <GeofenceCreatePanel />
          </div>

          <div className="h-[600px] min-h-[300px] overflow-hidden rounded-xl border border-gray-100 shadow-sm bg-white">
            <GeofenceMap
              zones={zones}
