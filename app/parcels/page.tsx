...
export default function ParcelsPage() {
  ...
  return (
    <DashboardLayout>
      ...
      <div className="shrink-0 flex items-center justify-between h-[48px]">
        <h1 className="text-2xl font-bold text-gray-900">Parcels</h1>
        
        <div className="w-[520px]">
          <div className="flex w-full gap-2 rounded-xl border border-gray-200 bg-white p-2 shadow-sm">
            <button
              onClick={() => setActiveTab("table")}
              className={`flex-1 px-3 py-1.5 rounded-lg text-xs leading-none font-medium transition ${
                activeTab === "table"
