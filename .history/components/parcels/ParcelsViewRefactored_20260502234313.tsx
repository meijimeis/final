...
const recomputeClusters = () => {
  ...
  return (
    <div className="grid h-full min-h-[520px] grid-cols-[400px_1fr_520px] gap-4">
      {/* LEFT - SETTINGS PANEL */}
      <div className="h-full bg-white rounded-lg shadow border border-gray-200 overflow-auto flex flex-col">
        <ParcelGroupSettings
          settings={settings}
      ...
      {/* CENTER - PARCEL LIST */}
      <div className="h-full bg-white rounded-lg shadow border border-gray-200 overflow-hidden flex flex-col">
